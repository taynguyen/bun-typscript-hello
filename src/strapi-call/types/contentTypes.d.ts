  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        ...
        'sections.company-showcase',
        'sections.blog-highlights',
        'sections.expert-guidance',
        'sections.top-service-provider-banner',
        'sections.expert-insight',
        'sections.js-script-snippet',
...
export interface ApiPageFooterPageFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<['sections.footer']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPageHeaderPageHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    sections: Schema.Attribute.DynamicZone<['sections.navigation-bar']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiServicesPageServicesPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    sections: Schema.Attribute.DynamicZone<
      [
        'services-page-sections.hero',
        'services-page-sections.benefits-list',
        'services-page-sections.service-offerings-grid',
        'sections.top-service-provider-banner',
      ]
    >;
    updatedAt: Schema.Attribute.DateTime;
